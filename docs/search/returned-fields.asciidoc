...
IMPORTANT NOTE
==============
This file has been generated from https://github.com/elastic/elasticsearch-net/tree/5.x/src/Tests/Search/ReturnedFields.doc.cs. 
...
In this case, we don't want to pay the cost of Elasticsearch deserializing the entire `_source` just to 
get a small field.
